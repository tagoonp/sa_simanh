...
<form name="addInstitute" id="addInstitute" action="./addInstitute.php" method="POST">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="300" align="left" class="paddingTable2"><input type="text" name="inst_name" id="inst_name" style="border-radius:5px; border:solid; border-width:1px; border-color:#CCC; outline:none; height:25px; width:200px; padding-left:5px;" /></td>
    ...
    <tr>
      ...
      <td align="left" class="paddingTable2" ><textarea name="inst_desc" rows="3" id="inst_desc" style="border-radius:5px; border:solid; border-width:1px; border-color:#CCC; outline:none; height:80px; width:260px; padding-left:5px;"></textarea></td>
    ...
    <tr>
      ...
      <td align="left" class="paddingTable2"><input type="text" name="inst_phone" id="inst_phone" style="border-radius:5px; border:solid; border-width:1px; border-color:#CCC; outline:none; height:25px; width:200px; padding-left:5px;" /></td>
      ...
      <td align="left"><span class="paddingTable2">
		...
		if($resultInstituteType){
			foreach($resultInstituteType as $v){
				?>
          <option value="<?php print $v[0];?>" <?php if($v[0]==2){ print "selected"; }?>><?php print $v[1];?></option>
          <?php	
			}	
		}
		?>
    ...
    <tr>
      <td height="30" colspan="2" align="left" ><input type="submit" name="button" id="button" value="+ Add" style="border-radius:5px; border:solid; border-width:1px; background-color:#069; height:35px; width:200px; padding-left:5px; cursor:pointer; color:#FFF;" /></td>
      <td align="left">&nbsp;</td>
      <td align="left">&nbsp;</td>
    </tr>
  </table>
