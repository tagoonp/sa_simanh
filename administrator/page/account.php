        ...
        <td height="300" align="left" valign="top" bgcolor="#FFFFFF" class="paddingTable"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:0.9em;">
              ...
              <tr>
                <td align="left" style="font-size:1.3em; padding:5px 0 5px 0;">User account management</td>
              </tr>
              <tr>
                <td align="left" style="color:#099;">List of user type.</td>
              </tr>
              <tr>
                <td align="left">&nbsp;</td>
              </tr>
              <tr>
                        <td align="left" style="padding:5px 0 5px 0;">
                        	<a href="main.php?id=2&amp;group_id=0&amp;tab_id=1" class="b">Add user account+</a>
                        </td>
                      </tr>
					<tr>
			  ...
			  <?php
				...
				$resultUserType = $db->select($strSQL,false,true);
				
				if($resultUserType){
					foreach($resultUserType as $v){
					?>
					<tr>
                        <td align="left" style="padding:5px 0 5px 0;">
                        	<a href="main.php?id=2&group_id=<?php print $v['user_type_id'];?>&tab_id=1" class="b"><div><?php print $v['user_type_description'];?></div></a>
                        </td>
                      </tr>
					<tr>
					  <td height="1" align="left" bgcolor="#EBEBEB" style="padding:0;"></td>
            ...
            <td  align="left" valign="top" style="padding-left:20px;"><table width="100%" border="0" cellspacing="0" cellpadding="0"  style="font-size:0.9em; color:#333">
              ...
              <tr>
				...
				$strSQL = sprintf("SELECT * FROM ".substr(strtolower($tbf),0,-2)."%s WHERE user_type_id = '%s'",mysql_real_escape_string("usertype"),mysql_real_escape_string($group_id));
              ...
              <tr>
                ...
                if($group_id==0){
					 if(isset($_GET['an'])){
						if($_GET['tab_id']==2){
							require "./page/view_account.php";
						}else{
							require "./page/edit_account.php";
						}
						
					 }else{
						 require "./page/add_new_account.php"; 
					 }	
				}else{
					?>
                  ...
                  <div class="css_simple_tab_detailed" style="display: <?php if($_GET['tab_id']==1){ print "block";}else{print "none"; }?>;">
                    <?php require "./page/browseAccount.php"; ?>
                    </div>
