...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
      ...
      <tr>
        ...
        if(isset($_GET['view'])){		
			if($_GET['query']==0){//<------- daily
				...
				?>
				<img src="./graph/simple_monthly.php?sdate=<?php print $_GET['sdate'];?>&edate=<?php print $edate;?>
                &graphType=<?php print $_GET['query'];?>&hospital=<?php print $hospital;?>&case=<?php print $_GET['case'];?>&view=<?php print $_GET['view'];?>&gtd=<?php print $_GET['gtd'];?>&dis=<?php print $_GET['dis'];?>" />
				<?php
				//}
			}
    ...
    <td width="250" align="left" valign="top" style="width:fixed; padding-left:20px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="24" align="left" valign="bottom">Query :</td>
      </tr>
      <tr> 
        <td height="35" align="left"><select name="query" id="query" style="height:30px; width:90%; padding-left:10px; border:solid; border-color:#CCC; border-width:1px; border-radius:5px;">
          ...
          <option value="1" <?php if($query==1){ print "selected";}?>>Monthly</option>
        </select></td>
      </tr>
		<tr>
		  <td height="24" align="left" valign="bottom" style="display:<?php if($query==0){ print "none";}?>;">View :</td>
	    </tr>
		<tr>
		  <td height="35" align="left" style="display:<?php if($query==0){ print "none";}?>;"><select name="view" id="view" style="height:30px; width:90%; padding-left:10px; border:solid; border-color:#CCC; border-width:1px; border-radius:5px;">
		    <option value="0" <?php if($query==1){ if($view==0){ print "selected";}}else{ print "selected"; }?>>All</option>
		    <option value="1" <?php if($query==1){ if($view==1){ print "selected";}}?>>Split by hospital</option>
          </select></td>
	    </tr>
		<tr>
      ...
      <tr>
        <td height="35" align="left" valign="bottom"><input type="button" name="view_btn4" id="view_btn4" value="View" style="background-color:#3C9; color:#FFF; border:none; border-radius:3px; cursor:pointer; width:60px; height:28px; font-weight:bold;" /></td>
      </tr>
    </table></td>
  </tr>
</table>
