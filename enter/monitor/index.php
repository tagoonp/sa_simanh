  ...
  <tr>
    <td width="250" height="700" align="left" valign="top" bgcolor="#000000"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="30" height="35" align="left"  style="padding-left:10px; color:#fff;">&nbsp;</td>
            <td align="left" style="padding-left:10px; color:#fff;" ><a href="../index.php" title="Delivery data for selected period">Back to main page</a></td>
          </tr>
        </table></td>
      </tr>
    ...
    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="50" bgcolor="#F3F3F3" style="padding-left:10px; padding-right:10px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" style="color:#666;">Welcome to SIMANH monitoring panel.</td>
            <td>&nbsp;</td>
            <td width="150" align="right">
            <input type="button" name="button" id="signout2" value="Signout" onclick="redirect_function('../../signout.php')" style="background-color:#C00; color:#FFF; border:none; border-radius:3px; cursor:pointer; width:100px; height:30px; font-weight:bold;" />
            </td>
          </tr>
        </table></td>
      </tr>
