...
<form id="birthRegForm" name="birthRegForm" method="post" action="../lib/saveDelivery.php"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <td height="30" colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td height="30" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;">
              <input type="number" name="ga_del" class="ip" id="number3" size="40" placeholder="Enter GA at delivery" required="required" value=<?php if($resultRecord2){ print $resultRecord2[0]['ga_adm'];}?> />
              </td>
          </tr>
          <tr>
  ...
  <input type="time" name="time_del" id="time_del" class="ip" />
          ...
          <tr id="modq2" style="display:<?php if(($resultDelivery[0][4]==2) || ($resultDelivery[0][4]==3) || ($resultDelivery[0][4]==4)){
            ...
            <td height="30" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;">
              Other : 
                <input type="text" name="ind_other" id="ind_other" class="ip" value=<?php print $resultDelivery[0][13];?> ></td>
          </tr>
          <tr>
          ...
          <tr>
            <td height="30" colspan="2" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;">Perineum :</td>
          </tr>
          <tr>
            <td height="30" colspan="2" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;"><div class="radioset">
              <input type="radio" id="rdg1" name="pi"  value="0" checked="checked" />
              <label for="rdg1">Infact</label>
              <input type="radio" id="rdg2" name="pi"  value="1"  <?php if($resultDelivery[0][8]==1){print "checked";}?>/>
              <label for="rdg2">Episiotomy</label>
            </div></td>
          </tr>
          <tr>
            <td height="30" colspan="2" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;">Episiotomy :</td>
          </tr>
          <tr>
            <td height="30" colspan="2" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;"><div class="radioset">
              <input type="radio" id="rdg3" name="pe"  value="0" checked="checked" />
              <label for="rdg3">No</label>
              <input type="radio" id="rdg4" name="pe"  value="1" />
              <label for="rdg4">Yes</label>
            </div></td>
          </tr>
          <tr>
            <td height="30" colspan="2" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;">Degree tear :<font color="#FF0000">&nbsp;</font></td>
          </tr>
          <tr>
            <td height="30" colspan="2" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;"><div class="radioset">
          ...
          <tr>
            <td height="30" colspan="2" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;">Antenatal client on AZT before labour :</td>
          </tr>
          <tr>
            <td height="30" colspan="2" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;"><div class="radioset">
          ...
          <tr>
            <td height="30" colspan="2" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;">Antenatal client Nevirapine taken during labour :</td>
          </tr>
          <tr>
            <td height="30" colspan="2" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;"><div class="radioset">
          ...
          <tr>
            <td height="30" colspan="2" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;">Truvada given to woman after delivery</td>
          </tr>
          <tr>
            <td height="30" colspan="2" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;"><div class="radioset">
