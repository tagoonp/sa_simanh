...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td colspan="2" align="center" style="padding-left:20px; padding-right:20px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="left" style="padding:3px;">Record number : <font color="#006699"><?php print $id;?></font> PID : <font color="#006699"><?php print $resultRegister[0]['pid'];?></font></td>
        </tr>
      <tr>
        <td align="left" style="padding:3px;"><div id="tabs">
          <ul>
	...
	<div id="tabs-1">
    	<?php require_once "./view/view_register.php"; ?>
     </div>
		<div id="tabs-2"><?php if($resultObstetric){require_once "./view/view_obstetric.php"; }?></div>
	<div id="tabs-3"><?php if($resultDelivery){require_once "./view/view_delivery.php";} ?></div>
    <div id="tabs-4"></div>
    <div id="tabs-5"></div>
    <div id="tabs-6"></div>
    <!--<div id="tabs-4"><?php require_once "./view/view_newborn.php"; ?></div>
    <div id="tabs-5"><?php require_once "./view/view_complication.php"; ?></div>
    <div id="tabs-6"><?php require_once "./view/view_postnatal.php"; ?></div>-->
</div>
        </td>
      </tr>
      <tr>
