<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td style="padding-left:10px; padding-right:10px;"><br />
      ...
      <tr>
        <td height="40" style="font-size:1.0em; padding-left:10px;">View obstetric information</td>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" 
            style="border:solid; border-color:#CCC; border-width:0px 1px 0px 1px;">
              <tr>
                <td height="40" align="center"><a href="main.php?id=1&amp;com=edit"><img src="../images/edit.png" width="30" height="30" /></a></td>
              </tr>
            </table>
          <?php } ?></td>
      </tr>
        ...
        <td height="30" colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            switch($resultObstetric[0][11]){
				...
				case 'Neg': print "Negative"; break;
				case 'Pos': print "Positive"; break;	
				case 'Uncertained retest': print "Uncertained retest"; break;
			}
			?></td>
          </tr>
          <tr>
