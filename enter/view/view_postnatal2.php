  ...
  <tr>
    <td style="padding-left:0px; padding-right:0px;"><br />
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:solid; border-color:#CCC; border-width:1px;">
        <tr>
          <td height="40" style="font-size:1.0em; padding-left:10px;"><strong>Postnatal information/</strong></td>
          <td width="50" style="font-size:1.0em; padding-left:10px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td>
              <?php
          if($resultPostnatal){
            ...
            style="border:solid; border-color:#CCC; border-width:0px 1px 0px 1px;">
              <tr>
                <td width="50" height="40" align="center"><a href="createSession.php?id=<?php print $_GET['id']; ?>&amp;mid=5&amp;com=edit"><img src="../images/edit.png" width="30" height="30" /></a></td>
              </tr>
            </table>
            <?php } }?></td>
            </tr>
        ...
        <tr>
          <td height="30" colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="30" colspan="2" bgcolor="#FFFFFF" style="padding:5px 0px 5px 0px; color:#333;"><?php
            ...
            <tr id="dod" >
              ...
              <td height="30" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;"><?php print $resultPostnatal[0][13]; ?></td>
            </tr>
            <tr>
