...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td style="padding-left:0px; padding-right:0px;"><br />
      ...
      <tr>
        <td height="40" style="font-size:1.0em; padding-left:10px;"><strong>Main admission data</strong></td>
        <td style="font-size:1.0em; padding-left:10px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            style="border:solid; border-color:#CCC; border-width:0px 1px 0px 1px;">
              <tr>
                <td height="40" align="center"><a href="createSession.php?id=<?php print $_GET['id']; ?>&amp;mid=0&amp;com=edit"><img src="../images/edit.png" width="30" height="30" /></a></td>
              </tr>
            </table>
            <?php
			}?></td>
