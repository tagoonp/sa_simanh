...
if($resultOutcome){
  ...
  <tr>
    <td style="padding-left:10px; padding-right:10px;"><br />
      ...
      <tr>
        <td height="40" style="font-size:1.0em; padding-left:10px;">Outcome information 1</td>
      ...
      <tr>
        ...
        <tr>
          ...
          <tr>
            ...
            <td height="30" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;"><select name="mode_of_birth" id="mode_of_birth" class="ip" style="width:250px; height:37px;">
          ...
          <tr>
            ...
            <td height="30" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;">
              <input type="text" name="hc" class="ip" id="number2" size="40" placeholder="Enter head circumference (cm), If no data enter 0" required="required" /></td>
          </tr>
          <tr>
            ...
            <td height="30" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;">
              <input type="text" name="fetal_length" class="ip" id="number3" size="40" placeholder="Enter fetal length (cm), If no data enter 0" required="required" /></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td height="30" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;"><div class="radioset">
              ...
              <input type="radio" id="rbm6" name="pmctv_lb" value="1"  />
          ...
          <tr>
            <td height="30" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;">Formula feeding :</td>
            <td height="30" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;"><div class="radioset">
