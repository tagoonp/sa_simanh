...
<form id="birthRegForm" name="birthRegForm" method="post" action="../lib/updateRecord.php">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="35" bgcolor="#666666" style="padding-left:10px; color:#fff;">Home / Edit registration record</td>
  </tr>
  <tr>
        ...
        <td style="font-size:1.0em; padding-left:10px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            style="border:solid; border-color:#CCC; border-width:0px 1px 0px 1px;">
              <tr>
                <td height="40" align="center"><a href="main.php"><img src="../images/view_icon.png" width="30" height="30" /></a></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
      ...
      <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td height="30" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;"><input type="date(yyyy-mm-dd)" name="adm_date" id="adm_date"  class="ip"  value="<?php print $resultRegister[0]['date_adm'];?>" />&nbsp;&nbsp;<input type="time" name="adm_time" id="adm_time" class="ip"  value="<?php print $resultRegister[0]['time_adm'];?>" /></td>
          </tr>
          <tr>
            <td height="30" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;">Folder number :</td>
            <td height="30" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;"><input name="folder_no" class="ip" id="textfield2" size="40" placeholder="Antenatal folder no."  value="<?php print $resultRegister[0]['folder_no'];?>"></td>
          </tr>
          <tr>
            <td height="30" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;">Point of delivery folder no.</td>
            <td height="30" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;"><input name="point_no" class="ip" id="textfield6" size="40" placeholder="Point of delivery folder no."  value="<?php print $resultRegister[0]['point_no'];?>"></td>
          </tr>
          <tr>
            ...
            <td height="30" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;">
              <select name="refer_status" id="refer_status" class="ip" style="width:250px; height:37px;">
                ...
                <option value="1" <?php if($resultRegister[0]['refer_in_status']==1){ print "selected"; }?> >Yes</option>
                </select>
              </td>
          </tr>
          <tr class="refer" style="display:<?php if($resultRegister[0]['refer_in_status']!=1){ print "none"; }?>;">
            ...
            <td height="30" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;"><input name="refer_facility" class="ip" id="refer_facility" size="40" placeholder="Facility's name"  value="<?php print $resultRegister[0]['refer_in_facility'];?>">
              </td>
          </tr>
          <tr class="refer" style="display:<?php if($resultRegister[0]['refer_in_status']!=1){ print "none"; }?>;">
            ...
            <td height="30" bgcolor="#FFFFFF" style="padding:5px 10px 0px 10px; color:#333;"><select name="stage_of_patient" id="stage_of_patient" class="ip" style="width:250px; height:37px;">
              ...
              <option value="2" <?php if($resultRegister[0]['stage_of_patient']==2){ print "selected"; }?>>Unstable</option>
              <option value="3" <?php if($resultRegister[0]['stage_of_patient']==3){ print "selected"; }?>>Coma</option>
              </select></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td height="30" bgcolor="#FFFFFF" style="padding:5px 10px 5px 10px; color:#333;"><input type="text" name="pid" class="ip" id="textfield3" size="40" required="required"  value="<?php print $resultRegister[0]['pid'];?>"></td>
          </tr>
          <tr>
            ...
            <input name="fname" class="ip" id="textfield7" size="20" placeholder="Firstname" type="text" required="required"  value="<?php print $resultRegister[0]['p_fname'];?>"></td>
          </tr>
          <tr>
            <td height="30" bgcolor="#FFFFFF" style="padding:5px 10px 5px 10px; color:#333;">&nbsp;</td>
            <td height="30" bgcolor="#FFFFFF" style="padding:5px 10px 5px 10px; color:#333;">
            <input name="mname" class="ip" id="textfield8" size="20" placeholder="Midname"  value="<?php print $resultRegister[0]['p_mname'];?>"/></td>
          </tr>
          <tr>
            <td height="30" bgcolor="#FFFFFF" style="padding:5px 10px 5px 10px; color:#333;">&nbsp;</td>
            <td height="30" bgcolor="#FFFFFF" style="padding:5px 10px 5px 10px; color:#333;">
            <input name="lname" class="ip" id="textfield" size="20" placeholder="Surname"  value="<?php print $resultRegister[0]['p_lname'];?>"></td>
          </tr>
          <tr>
            <td height="30" valign="top" bgcolor="#FFFFFF" style="padding:5px 10px 5px 10px; color:#333;">Address :</td>
            <td height="30" valign="top" bgcolor="#FFFFFF" style="padding:5px 10px 5px 10px; color:#333;"><textarea name="address" cols="60" rows="5" class="ip" id="address" style="height:70px;"><?php print $resultRegister[0]['p_address'];?></textarea></td>
          </tr>
          <tr>
            <td height="30" bgcolor="#FFFFFF" style="padding:5px 10px 5px 10px; color:#333;">Phone number : </td>
            <td height="30" bgcolor="#FFFFFF" style="padding:5px 10px 5px 10px; color:#333;">
            <input name="phonenumber" class="ip" id="textfield4" size="40" placeholder="Phone number" type="text"  value="<?php print $resultRegister[0]['p_phone'];?>"></td>
          </tr>
          <tr>
            <td height="30" bgcolor="#FFFFFF" style="padding:5px 10px 5px 10px; color:#333;">Date of birth : </td>
            <td height="30" bgcolor="#FFFFFF" style="padding:5px 10px 5px 10px; color:#333;">
            <input type="date" name="dob" id="dob"  class="ip"   value="<?php print $resultRegister[0]['p_dob'];?>"></td>
          </tr>
          <tr>
            <td height="30" bgcolor="#FFFFFF" style="padding:5px 10px 5px 10px; color:#333;">Age : <font color="#FF0000">*</font></td>
            <td height="30" bgcolor="#FFFFFF" style="padding:5px 10px 5px 10px; color:#333;"><input type="number" name="c_age" class="ip" id="c_age" size="40" placeholder="Current age" required="required"  value="<?php print $resultRegister[0]['p_cage'];?>" /></td>
          </tr>
          <tr>
